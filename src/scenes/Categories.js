...
class Categories extends Component<Props> {
  ...
  render() {
    return (
      <ScrollView style={{width:'100%',height:'100%',paddingTop:'3%',paddingLeft:'3%',paddingRight:'3%'}}>
        ...
        <Product>{(products)=>
          <FlatList
            ...
            renderItem={(item) => <ListObject data={item.item} onPress={()=>{this.props.navigation.navigate('ListingPage',{category:item.item})}}/>}
          />
        }
        </Product>
      </ScrollView>
